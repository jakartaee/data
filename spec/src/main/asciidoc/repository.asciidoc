...
The Query's annotation will support a search expression as a String. The specification won't support the query syntax, which might vary between vendors and data sources, such as SQL, JPA-QL, Cypher, CQL, etc.
...
|Specify a static several sorting orders
