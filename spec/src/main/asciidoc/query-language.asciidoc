...
- each subsequent element is evaluated in the context of the result produced the previous element, and evaluates to the value of the named field of the result.
