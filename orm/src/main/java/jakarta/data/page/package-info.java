 ...
 * unique identifier. The predictable order makes it possible to retrieve the
 * query results from the database in separate pages.</p>
 *
 * <p>Pages can be determined based on fixed positional offset or relative to a
 * cursor.</p>
 *
 * <p>The elements of a {@link jakarta.data.page.Page} are computed based on
 * their
 ...
 * 1 to 10.</p>
 *
 * <p>For situations where the above must be avoided or the application wishes
 * to
 ...
 * approach with {@link jakarta.data.page.CursoredPage}. In this approach,
 * queries for the next or previous page are performed relative to the last or
 * first entry of the current page.</p>
 *
