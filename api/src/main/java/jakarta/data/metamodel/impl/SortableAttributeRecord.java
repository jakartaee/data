 ...
 * specific subtype of {@link SortableAttribute} that applies to the entity
 * attribute, such as {@link TextAttribute#of(Class, String) TextAttribute} or
 * {@link NumericAttribute#of(Class, String, Class) NumericAttribute}.
 */
@Deprecated(since = "1.1")
public record SortableAttributeRecord<T>(@Nonnull String name)
