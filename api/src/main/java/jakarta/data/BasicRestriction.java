...
record BasicRestriction<T>(
    ...
    BasicRestriction(String field, boolean negated, Operator comparison, Object value) {
    ...
    @Override
    public Basic<T> ignoreCase() {
        return new BasicRestriction<>(field, isNegated, comparison, true, value);
    }
}