 ...
 * entities.</p>
 *
 * <p>The type parameters of {@code BasicRepository<T,K>} capture the primary
...
public interface BasicRepository<T, K> extends DataRepository<T, K> {
     ...
     * update the existing record in the database. If the entity does not exist
     * in the database or has a null Id, then this method will insert a new
     * record into the database.</p>
     *
     * <p>The entity instance that is returned as a result value of this method
     * must be updated with all automatically generated values and incremented
     * values that changed due to the save. After invoking this method, do not
     * continue to use the entity value that is supplied as a parameter. This
     * method makes no guarantees about the state of the entity value that is
     * supplied as a parameter.</p>
     *
     * <p>If the entity uses optimistic locking and the version differs from the
     ...
     *                                           database differs from the
     *                                           version in the entity.
     ...
     * that exists in the database, the method will update the existing record.
     * Otherwise, it will insert a new record.
     *
     * <p>If an entity has a non-null Id, this method will attempt to update
     * the
     * existing record in the database. If an entity does not exist in the
     * database or has a null Id, then this method inserts a new record into the
     * database.</p>
     *
     * <p>The entity instances that are returned as a result of this method
     * must be updated with all automatically generated values and incremented
     * values that changed due to the save. After invoking this method, do not
     * continue to use the entity values that are supplied in the parameter.
     * This method makes no guarantees about the state of the entity values that
     * are supplied in the parameter.</p>
     *
     ...
     *                                           database.
     * @throws NullPointerException              If either the iterable is null
     ...
     *                                       databases that are not capable of
     ...
     * @throws IllegalArgumentException when {@code PageRequest} that is
     *                                  supplied to this method has the
     *                                  {@link PageRequest.Mode#CURSOR_NEXT} or
     *                                  {@link PageRequest.Mode#CURSOR_PREVIOUS}
     *                                  pagination mode selected.
     ...
     * @throws OptimisticLockingFailureException if the entity is not found in
     *                                           the database for deletion or
     *                                           has a version for optimistic
     *                                           locking that is inconsistent
     ...
     *                 elements.
     * @throws OptimisticLockingFailureException If an entity is not found in
     *                                           the database for deletion or
     *                                           has a version for optimistic
     *                                           locking that is inconsistent
     *                                           with the version in the
