...
public interface PageableRepository<T, K> extends CrudRepository<T, K> {
     ...
     * @throws UnsupportedOperationException for Key-Value and Wide-Column databases when the {@link Pageable.Mode#CURSOR_NEXT} or {@link Pageable.Mode#CURSOR_PREVIOUS} pagination mode is selected.
     * @see Pageable.Mode
     */
