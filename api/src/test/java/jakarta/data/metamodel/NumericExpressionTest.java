...
class NumericExpressionTest {
    ...
    @Test
    @DisplayName("should create divideBy expression with literal")
    void shouldCreateDivideByWithLiteral() {
        var expression = (NumericOperatorExpression<?, ?>) _Invoice.amount.divideBy(4);
    ...
    void shouldCreateDivideByWithExpression() {
        var expression = (NumericOperatorExpression<?, ?>) _Invoice.amount.divideBy(_Invoice.amount);
    ...
    void shouldIncludeParenthesesInToString() {
        NumericExpression<Invoice, Integer> expression =
                _Invoice.amount.times(
                        _Invoice.percentDiscount.subtractFrom(100))
                .divideBy(100);
