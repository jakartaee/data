...
class CompositeRestrictionRecordTest {
    ...
    void shouldCreateCompositeRestrictionWithDefaultNegation() {
        Restriction<String> restriction1 = new BasicRestrictionRecord<>("title", Range.value("Java Guide"));
        Restriction<String> restriction2 = new BasicRestrictionRecord<>("author", Range.value("John Doe"));
