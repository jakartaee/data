...
class CompositeRestrictionRecordTest {
    ...
    void shouldCreateCompositeRestrictionWithDefaultNegation() {
        Restriction<String> restriction1 = new BasicRestrictionRecord<>("title", Operator.EQUAL, new Value<>("Java Guide"));
        Restriction<String> restriction2 = new BasicRestrictionRecord<>("author", Operator.EQUAL, new Value<>("John Doe"));
