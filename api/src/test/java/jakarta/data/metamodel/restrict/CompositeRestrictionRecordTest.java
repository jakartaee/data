...
class CompositeRestrictionRecordTest {
    ...
    void shouldCreateCompositeRestrictionWithDefaultNegation() {
        Restriction<String> restriction1 = new BasicRestrictionRecord<>("title", new Value<>("Java Guide"));
        Restriction<String> restriction2 = new BasicRestrictionRecord<>("author", new Value<>("John Doe"));
