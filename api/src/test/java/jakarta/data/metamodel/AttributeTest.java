...
class AttributeTest {
    ...
    void shouldCreateEqualToRestriction() {
        ...
        ValueRestriction<Person, String> restriction =
                (ValueRestriction<Person, String>) testAttribute.equalTo("testValue");
    ...
    void shouldCreateNotEqualToRestriction() {
        @SuppressWarnings("unchecked")
        ValueRestriction<Person, String> restriction =
                (ValueRestriction<Person, String>) testAttribute.notEqualTo("testValue");
    ...
    void shouldCreateInRestriction() {
        @SuppressWarnings("unchecked")
        ValueRestriction<Person, String> restriction =
                (ValueRestriction<Person, String>) testAttribute.in(Set.of("value1", "value2"));
    ...
    void shouldCreateNotInRestriction() {
        @SuppressWarnings("unchecked")
        ValueRestriction<Person, String> restriction =
                (ValueRestriction<Person, String>) testAttribute.notIn(Set.of("value1", "value2"));
    ...
    void shouldCreateIsNullRestriction() {
        @SuppressWarnings("unchecked")
        ValueRestriction<Person, String> restriction =
                (ValueRestriction<Person, String>) testAttribute.isNull();
    ...
    void shouldCreateNotNullRestriction() {
        @SuppressWarnings("unchecked")
        ValueRestriction<Person, String> restriction =
                (ValueRestriction<Person, String>) testAttribute.notNull();
