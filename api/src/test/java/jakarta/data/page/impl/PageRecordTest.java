...
class PageRecordTest {
    ...
    void shouldBeImmutable() {
        ...
        PageRequest page4Request =
                PageRequest.ofSize(5).pageNumber(4).withTotal();
    ...
    void shouldCreateInstanceWithCustomConstructor() {
        ...
        PageRequest page2Request = PageRequest.ofSize(4).pageNumber(2);
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(page2.nextPageRequest()).isEqualTo(PageRequest.ofSize(4).pageNumber(3));
            softly.assertThat(page2.numberOfElements()).isEqualTo(4);
            softly.assertThat(page2.previousPageRequest()).isEqualTo(PageRequest.ofSize(4).pageNumber(1));
        });
        ...
        PageRequest page5Request = PageRequest.ofSize(4).pageNumber(5);
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(page5.previousPageRequest()).isEqualTo(PageRequest.ofSize(4).pageNumber(4));
        });
    ...
    void shouldCreateInstanceWithRecordConstructor() {
        ...
        PageRequest page1Request = PageRequest.ofSize(5).pageNumber(1);
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(page1.nextPageRequest()).isEqualTo(PageRequest.ofSize(5).pageNumber(2));
        ...
        PageRequest page3Request = PageRequest.ofSize(5).pageNumber(3);
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(page3.nextPageRequest()).isEqualTo(PageRequest.ofSize(5).pageNumber(4));
            softly.assertThat(page3.numberOfElements()).isEqualTo(5);
            softly.assertThat(page3.previousPageRequest()).isEqualTo(PageRequest.ofSize(5).pageNumber(2));
