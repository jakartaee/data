    ...
    void shouldThrowExceptionWhenKeysetIsNotSupported() {
        assertThatThrownBy(() -> {
            ...
            pagination.next();
                ...
                .hasMessage("Not supported for key-based pagination. Instead use afterKey or afterCursor to provide the next key values or obtain the nextPageRequest from a CursoredPage.");
    }
}
