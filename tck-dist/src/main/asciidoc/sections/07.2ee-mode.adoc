...
[source, xml]
----
include::{starterLoc}/ee-pom.xml[tags=configJunit5;!arquillian;!logging;!displayName;!entity]
----
...
To accomplish this tests are annotated with either `@Persistence`, `@NoSQL`, or no annotation.

When configuring Junit5 add a System Property for the entity(s) your implementation supports. 

Example se-pom.xml:

[source, xml]
----
include::{starterLoc}/ee-pom.xml[tags=systemProperties;!signature;!standalone;!logging;!arquillian]
----
