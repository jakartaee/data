...
The Jakarta Data specification provides an API for easier data access to a variety of database types, both relational and NoSQL. A Java developer can access those repositories a number of ways, including the ability to compose custom query methods on a Repository interface.
