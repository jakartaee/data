...
public interface ProductRepository extends PageableRepository<Product, Long> {
 ...
 Page<Car> findByTypeOrderByName(Type type, Pageable pageable);
...
link:++https://calendar.google.com/calendar/u/0/embed?src=eclipse-foundation.org_e9ki8t2gc75sh07qdh95c8ofvc@group.calendar.google.com&ctz=Europe/Lisbon++[Mountain]
